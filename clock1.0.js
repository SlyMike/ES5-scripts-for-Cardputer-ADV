...
// Helpers
function setTextEnv(){ if (typeof display.setTextColor==="function") display.setTextColor(WHITE); if (typeof display.setTextSize==="function") display.setTextSize(1); }
...
function drawClock(timeStr){
  ...
  var tw = timeStr.length*18; // approx width for size 3
