// features untested: UART, BAUD, GPS
// ES5 GPS NMEA Parser for Cardputer ADV (Bruce v1.12)
// UART: TX=G1, RX=G2 | Baud persistence in RAM only
// Features: Time, Lat, Lon, Satellites, HDOP, Fix Status, Colour Cycling
...
function drawHud(){
  ...
  setTextEnv();
  printAt(6,H-HUDH+2,"Sats:"+gpsSats+" Fix:"+gpsFix+" HDOP:"+gpsHdop+" Baud:"+baudRates[baudIndex]);
}
